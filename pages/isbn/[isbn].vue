...
const goodreadURL = useState("goodreadURL");
const route = useRoute();
const router = useRouter();

const back = () => router.back();

currentBook.value = await $fetch("/api/book/" + route.params.isbn);
goodreadURL.value = await getGoodReadURL(currentBook.value.isbn);
console.log(goodreadURL);
onMounted(async () => {});
