<template>
  <div class="container">
    <div class="book">
      ...
      <div :style="backgroundStyles" class="book-cover cover1">
...
<script setup>
const props = defineProps(["book", "isReady"]);
const img = useImage();
const backgroundStyles = useState("backgroundStyles");

const { name, title, coverurl, review } = props.book;

const imgUrl = img(coverurl, {
  format: "avif",
  quality: 70,
});
